...
Progress.streets = (function Streets($, L) {
	...
	function _init() {
		...
		$.getJSON("json.pyhtml?type=main&file=new4.geojson", function(data) {
		...
		$.getJSON("json.pyhtml?type=main&file=new3.geojson", function(data) {
		...
		$.getJSON("json.pyhtml?type=main&file=SmallMap_02_Streets.geojson", function(data) {
		...
		// Show sidewalks
		$.getJSON("json.pyhtml?type=main&file=SmallMap_02_Sidewalks.geojson", function(data) {
